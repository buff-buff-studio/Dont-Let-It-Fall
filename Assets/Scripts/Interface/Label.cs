...
namespace DLIFR.Interface
{
    ...
    { 
        ...
        #if UNITY_EDITOR
        [MenuItem("GameObject/DLIFR/Label", false, 0)]
        static void CreateNew(MenuCommand menuCommand) 
        {
            ...
            textComponent.text = "[ui.new_label]";
            
            for(int i = 0; i < 5; i ++)
                UnityEditorInternal.ComponentUtility.MoveComponentUp(label);

            UnityEditorInternal.ComponentUtility.MoveComponentDown(label);
